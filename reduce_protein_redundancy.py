#Parsing protein blast results to create a new protein fasta with reduced redundancy

#run at the commandline like this: 
#python ./parsing_protein_blast_results_v.0.1.py <Blastp_results> <protein_fasta> <new_file_name>
...
def extractProteins(blastPFile, fasta, newFileName):
    '''extractProteins takes the list generated by removeProteinDuplicates and 
    creates a new files with only those sequence names in the new protein
    fasta file, thus removing redundancy from the file.
    '''
